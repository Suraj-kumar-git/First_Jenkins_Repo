package com.suraj.employeemanagementsystem.controller;
...
import com.suraj.employeemanagementsystem.service.EmployeeService;
...
public class EmployeeController {
	...
	public String showNewEmployeeForm(Model model) {
		Employee_Management_System employee = new Employee_Management_System();
	...
	public String saveEmployee(@ModelAttribute("employee") Employee_Management_System employee) {
	...
	public String showUpdateForm(@PathVariable Long id, Model model) {
		...
		Employee_Management_System employee = employeeService.getEmployeeById(id);
